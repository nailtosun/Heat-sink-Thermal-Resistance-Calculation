...
velocityOfFlow = 1.93; %m/s @8.03CFM brushless dc motor fan
Cp = 1.007; %kJ/(kg*K)
k_air = 27.35E-3 % W/m-K
dynamic_viscosity = 19.07E-6 % Pa s
ambient_temperature = 273+40; %K
...
h = Nu*k_air/b; %W/m-K
%% Thermal Interface
R_tim = thermal_interface(5,2*10^-3,(2.5*10^-2)^2); %h,length at z, Area
